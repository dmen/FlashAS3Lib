...
package com.sagecollective.utilities
{
	...
	public class CornerQuit extends EventDispatcher
	{
		...
		private var debug:Number; //set in constructor - if true corners will be drawn in yellow instead of being hidden
		...
		public function init($container:DisplayObjectContainer, position:String = "ul"):void
		{
			...
			switch(pos1) {
				case "ul":
					...
					break;
				case "ur":
					hitArea.x = container.width - 150;
					hitArea.y = 0;
					break;
				case "ll":
					hitArea.x = 0;
					hitArea.y = container.height - 150;
					break;
				case "lr":
					hitArea.x = container.width - 150;
					hitArea.y = container.height - 150;
			...
			switch(pos2) {
				case "ul":
					...
					break;
				case "ur":
					hitArea2.x = container.width - 150;
					hitArea2.y = 0;
					break;
				case "ll":
					hitArea2.x = 0;
					hitArea2.y = container.height - 150;
					break;
				case "lr":				
					hitArea2.x = container.width - 150;
					hitArea2.y = container.height - 150;
