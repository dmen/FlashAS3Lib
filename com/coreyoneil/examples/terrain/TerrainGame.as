package
{
	...
	public class TerrainExample extends Sprite
	{
		...
		private function init(e:Event = null):void
		{
			...
			_collisionList = new CollisionList(_wheel);//target
			
			_collisionList.addItem(terrain);
			_collisionList.addItem(target);
		...
		{			
			...
			if(collisions.length)
			{
				...
				if (collision.object1.name == "target" || collision.object2.name == "target") {
					trace("win");
				}
				//for (var key:String in collision){
					//trace(key,collision[key]);					
				//}
