package com.gmrmarketing.rbc.etransfer
{
	...
	public class Queue extends EventDispatcher  
	{
		...
		private const FORM_URL:String = "https://rbcshoutvideo.thesocialtab.net/Home/Register?";
		private const VIDEO_URL:String = "https://rbcshoutvideo.thesocialtab.net/Home/SubmitVideo";
		private const DATA_FILE_NAME:String = "rbcData.csv";
		private const SAVED_FILE_NAME:String = "rbcSaved.csv"; //users successfully uploaded
		...
		{	
			...
			videoFolder = new File("c:\\Program Files\\Adobe\\Flash Media Server 4.5\\applications\\rbc\\streams\\_definst_");
		...
		{			
			return "c:/Program Files/Adobe/Flash Media Server 4.5/applications/rbc/streams/_definst_/";
		}
		/**
		 * called from Main.videoDone()
		 * Data object contains fname,lname,email,guid keys	
		 */
