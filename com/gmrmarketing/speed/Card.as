...
{	
	...
	public class Card extends MovieClip
	{
		...
		{			
			...
			loader.rotation = rotateSlider.getNormalizedDelta() * 180;
		}
		//}
		...
		private function showAlmostDone(begin:Boolean = true):void
		{
			...
			stage.addEventListener(MouseEvent.CLICK, closeAlmostDoneDialog, false, 0, true);
		}
		...
		private function closeAlmostDoneDialog(e:MouseEvent = null):void
		{
			...
			stage.removeEventListener(MouseEvent.CLICK, closeAlmostDoneDialog);
