...
{	
	...
	public class Webcam3D_1280x960 extends BRFBasicView 
	{
		...
		{	
			...
			eraArray = new Array([clip.eraSelector.b1, "helmw.zf3d", "sharksAway.png"], [clip.eraSelector.b2, "helmb.zf3d","kingsHome.png"], [clip.eraSelector.b3, "helmw.zf3d","kingsAway.png"], [clip.eraSelector.b4, "helmb.zf3d","sharksHome.png"], [clip.eraSelector.b5, "helmw.zf3d","sharksAway.png"], [clip.eraSelector.b6, "helmb.zf3d","kingsHome.png"], [clip.eraSelector.b7, "helmw.zf3d","kingsAway.png"], [clip.eraSelector.b8, "helmb.zf3d","sharksHome.png"]);
		...
		public function show():void
		{
			...
			if (clip) {
				...
				clip.eraSelector.b1.rotation = 0;
				clip.eraSelector.b2.rotation = 0;
				clip.eraSelector.b3.rotation = 0;
				clip.eraSelector.b4.rotation = 0;
				clip.eraSelector.b5.rotation = 0;
				clip.eraSelector.b6.rotation = 0;
				clip.eraSelector.b7.rotation = 0;
				clip.eraSelector.b8.rotation = 0;
				
				clip.eraSelector.b1.gotoAndStop(1);
				clip.eraSelector.b2.gotoAndStop(1);
				clip.eraSelector.b3.gotoAndStop(1);
				clip.eraSelector.b4.gotoAndStop(1);
				clip.eraSelector.b5.gotoAndStop(1);
				clip.eraSelector.b6.gotoAndStop(1);
				clip.eraSelector.b7.gotoAndStop(1);
				clip.eraSelector.b8.gotoAndStop(1);
		...
		override public function initGUI() : void 
		{
			...
			jerseyMatrix.scale(.75, .75);
			jerseyMatrix.translate(110, 270);			
		}
		...
		{			
			...
			_brfManager.vars.faceEstimationVars.minShapeDimension = 1;
		...
		private function nextEra(e:MouseEvent):void
		{
			...
			if (okToRotate) {
				...
				TweenMax.to(clip.eraSelector.b1, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b2, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b3, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b4, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b5, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b6, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b7, rTime, { rotation:"-45" } );
				TweenMax.to(clip.eraSelector.b8, rTime, { rotation:"-45", onComplete:eraRotationComplete } );
		...
		{
			trace("loadJersey:", jerseyPath + eraArray[eraIndex][2]);
			var l:Loader = new Loader();
			l.contentLoaderInfo.addEventListener(Event.COMPLETE, jerseyLoaded, false, 0, true);			
			l.load(new URLRequest(jerseyPath + eraArray[eraIndex][2]));			
		}
