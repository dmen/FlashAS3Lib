package com.gmrmarketing.sap.boulevard.avatar
{
	...
	public class Main extends MovieClip
	{
		...
		private var preview:ExampleWebcam3D_1280x960; //web cam preview - with facial recognition
		...
		public function Main()
		{
			...
			*/
			...
			preview = new ExampleWebcam3D_1280x960();					
		...
		{		
			tim.buttonClicked();
			preview.removeEventListener(ExampleWebcam3D_1280x960.TAKE_PHOTO, startCountdown);
		...
		{	
			...
			preview.removeEventListener(ExampleWebcam3D_1280x960.CLOSE_PREVIEW, reset);
