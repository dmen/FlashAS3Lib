package com.gmrmarketing.sap.metlife.giants.twitterTicker
{
	...
	{		
		...
		public function init():void
		{
			...
			var r:URLRequest = new URLRequest("http://sapmetlifeapi.thesocialtab.net/Api/GameDay/GetCachedFeed?feed=SAPGiantsTweets" + "&abc=" + String(new Date().valueOf()));
