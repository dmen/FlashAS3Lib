package com.gmrmarketing.sap.ticker
{
	...
	public class SoccerFacts
	{
		...
		public function SoccerFacts()
		{
			...
			facts.push("There has never been a European team that won the title when the tournament took place in South America");
			...
			facts.push("Brazil was won more championships (5), scored more goals (210) and won more games (67) than any other team since 1930");
