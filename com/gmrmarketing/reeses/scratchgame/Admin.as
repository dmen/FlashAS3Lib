...
*/
		...
		{			
			...
			var prizes:Array = ["Prize A", "Prize B", "Prize C"];// theData.prizes;
			var descriptions:Array = ["Prize A", "Prize B", "Prize C"];// theData.descriptions;
			
			clip.percent.restrict = "0-9";
			clip.percent.text = 50;// theData.winPercent;
		...
		public function reportingClicked(e:MouseEvent = null):void
		{
			...
			var prizes:Object = theData.prizeCounts;
			clip.prizeList.text = "";
		...
		{
			//af.resetScratchData();//game data only - not prizes/descriptions
...
/*
		...
		{
			theData = new Object();
			var oldData:Object = af.getData(); //need this for scratch reporting data - started,won,lost array
