/**
 * Encodes a flv generated by adobe media server to an mp4
 * uses FFMPEG and NativeProcess
 * 
 * Note: you must use Extended Desktop publishing profile only
 * otherwise you'll get an error about native process not supported in the current profile
 */
package com.gmrmarketing.goldenOne.cheerBooth2016
{
	...
	public class Encode extends EventDispatcher
	{
		...
		{
			userPath = "C:\\Program Files\\Adobe\\Flash Media Server 4.5\\applications\\goldenOne\\streams\\_definst_\\";
			outputPath = File.applicationStorageDirectory.nativePath + "\\";			
		}
		
		
		/**
		 * Called from VideoBG.stopRecording()
		 * encodes user.flv in the the ams folder
		 * @param	guid
		 */
