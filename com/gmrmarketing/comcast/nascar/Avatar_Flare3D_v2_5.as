package com.gmrmarketing.comcast.nascar {	
	...
	public class Avatar_Flare3D_v2_5 extends BRFContainerFP11 {
		...
		public function removeHelmet():void
		{
			_baseNode.removeChild(_holder);
		}
		public function addHelmet():void
		{
		...
		public function debug(pos:Array, scale:Array):void
		{
			_holder.setPosition(pos[0], pos[1], pos[2]);
			_holder.setScale(scale[0], scale[1], scale[2]);
		}
		...
		{			
			...
			if(model != null) {
				...
				if(holderOld != null) {
					...
					_holder.setScale(1.05, 1.05, 1.05);
		...
		//base : Pivot3D, prefix : String = null
		public function traceChildren() : void {
			trace("scene children:", _scene.children.length);
			trace("maxDirectional:", _scene.lights.maxDirectionalLights);
			trace("maxPoint:", _scene.lights.maxPointLights);
