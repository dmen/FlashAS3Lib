	...
	{		
		...
		{	
			if (hasToken()) {
				...
				var resp:Object = { "AccessToken":token, "MethodData": { "InteractionId":270, "DeviceId":"AAB3B7F4-16AF-E071-8089-F826A6E50DD4", "DeviceResponseId":15, "ResponseDate":now, "FieldResponses":[ { "FieldId":2060, "Response":formData[0] }], "Latitude":"0", "Longitude":"0" }};
		...
		{
			var resp:Object = { "AccessToken":token, "MethodData": { "InteractionResponseId":responseId, "FieldId":2059, "Response":thePhoto }};			
			var js:String = JSON.stringify(resp);
		...
		{	
			var ts:String = Utility.hubbleTimeStamp; //Strings.timestamp();
