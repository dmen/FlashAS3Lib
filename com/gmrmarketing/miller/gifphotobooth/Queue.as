	...
	public class Queue extends EventDispatcher  
	{
		...
		private function uploadNext():void
		{
			if (hubble.hasToken() && !hubble.isBusy() && users.length > 0) {			
				...
				hubble.submit(new Array(curUpload.dob, curUpload.email, curUpload.phone, gString, curUpload.opt1, curUpload.opt2, curUpload.opt3, curUpload.opt4, curUpload.opt5));
			}
		}
