...
package com.gmrmarketing.miller.gifphotobooth
{
	...
	{		
		 ...
		 * @param	curUpload.dob, curUpload.email, curUpload.phone, gString, curUpload.opt1, curUpload.opt2, curUpload.opt3	
		 */
		...
		{	
			if (hasToken()) {
				...
				var resp:Object = { "AccessToken":token, "MethodData": { "InteractionId":209, "DeviceId":"Flash", "DeviceResponseId":13, "ResponseDate":Strings.hubbleTimestamp(), "FieldResponses":[ { "FieldId":1484, "Response":formData[0] }, { "FieldId":1485, "Response":formData[1] },{ "FieldId":1486, "Response":formData[2] }, { "FieldId":1488, "Response":formData[4] }, { "FieldId":1489, "Response":true }, { "FieldId":1490, "Response":formData[5] }, { "FieldId":1491, "Response":formData[6] }], "Latitude":"0", "Longitude":"0" }};
