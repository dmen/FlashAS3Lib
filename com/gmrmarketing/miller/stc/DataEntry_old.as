package com.gmrmarketing.miller.stc
{
	...
	public class DataEntry extends EventDispatcher
	{
		...
		public function show():void
		{
			...
			clip.phone.p2.text = "";
			clip.phone.p3.text = "";
			clip.phone.p1.restrict = "0-9";
			clip.phone.p2.restrict = "0-9";
			clip.phone.p3.restrict = "0-9";
			
			clip.fname.theName.text = "";
			//clip.fname.theName.restrict = "^0-9";//Keyboard class needs expanding restrict...
		...
		private function checkPreFilleds(e:Event):void
		{
			...
			if (clip.stage.focus == clip.phone.p2) {
				clip.pref.visible = false;
				checkOtherPreFilleds(clip.phone.p2);
			}
			if (clip.stage.focus == clip.phone.p3) {
				clip.four.visible = false;
				checkOtherPreFilleds(clip.phone.p3);
			}
			if (clip.stage.focus == clip.fname.theName) {
				clip.nam.visible = false;
				checkOtherPreFilleds(clip.fname.theName);
			}
		}
