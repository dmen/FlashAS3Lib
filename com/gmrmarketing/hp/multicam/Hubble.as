...
package com.gmrmarketing.hp.multicam
{
	...
	{		
		 ...
		 * @param	formData Object with keys: email,gif
		 */
		...
		{	
			if (hasToken()) {
				...
				didPrint = false;// formData.print;//boolean
				...
				if (formData.responseID != -1) {
					...
					var resp:Object = { "AccessToken":token, "MethodData": { "InteractionId":232, "DeviceId":myGUID, "DeviceResponseId":formData.deviceResponseID, "ResponseDate":Strings.hubbleTimestamp(), "FieldResponses":[ { "FieldId":1705, "Response":formData.email }], "Latitude":"0", "Longitude":"0" }};
		...
		{			
			var resp:Object = { "AccessToken":token, "MethodData": { "InteractionResponseId":responseId, "FieldId":1704, "Response":thePhoto }};			
			var js:String = JSON.stringify(resp);
