...
{		
	...
	public class Admin extends EventDispatcher
	{
		...
		public function Admin()
		{
			...
			items = new Array("heritage", "innovation", "racing", "scout", "war", "faithful", "ahead", "all");
		}
		...
		public function show($container:DisplayObjectContainer):void
		{
			...
			clip.b9.addEventListener(MouseEvent.MOUSE_DOWN, itemPicked, false, 0, true);
		}
		...
		public function hide():void
		{
			...
			clip.b9.removeEventListener(MouseEvent.MOUSE_DOWN, itemPicked);
		}
		...
		private function itemPicked(e:MouseEvent):void
		{
			...
			var selInd:int = parseInt(String(m.name).substr(1, 1)); //1 - 9
