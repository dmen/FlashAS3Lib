/**
 * First version - uses Hot Virtual Keyboard
 * Not used any longer
 */
package com.gmrmarketing.indian.heritage
{
	...
	import com.gmrmarketing.utilities.HVK;
	...
	public class Main extends MovieClip
	{
		...
		private var hvk:HVK; //hot virtual keyboard
		...
		public function Main()
		{
			...
			timeoutHelper.init(120000);//two minute
			...
			hvk = new HVK();//wrapper for hot virtual kbd
			hvk.hide();
		...
		private function enableForm():void
		{
			hvk.show();
			checkKeys();
			stage.focus = imagesNav.theForm.theName;
		 ...
		 * @param	e
		 */
		private function checkField(e:Event):void
		{
		...
		private function uncheckKeys():void
		{
			stage.removeEventListener(KeyboardEvent.KEY_DOWN, keyResetTimeout);
			removeEventListener(Event.ENTER_FRAME, checkField);
		}
		private function checkKeys():void
		{
			stage.addEventListener(KeyboardEvent.KEY_DOWN, keyResetTimeout, false, 0, true);
			addEventListener(Event.ENTER_FRAME, checkField, false, 0, true);
		}
		private function keyResetTimeout(e:KeyboardEvent):void
		{
			timeoutHelper.buttonClicked();
		}
		...
		{
			imagesNav.theForm.theName.text = "";
