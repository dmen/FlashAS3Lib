...
package com.gmrmarketing.nissan.next
{
	...
	public class CoolEntry_CANADA extends EventDispatcher
	{
		...
		public function CoolEntry_CANADA($serviceURL:String)
		{
		...
		private function submitClicked(e:MouseEvent):void
		{
			...
			var request:URLRequest = new URLRequest(serviceURL + "?post=" + mess);
