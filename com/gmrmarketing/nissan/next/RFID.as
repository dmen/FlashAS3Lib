 ...
 * Requires clip rfidClip in the library
 * rfidClip must contain two dynamic fields
 * one to display the main text - theText
 * one to capture rfid scans, located off stage - rfidField
 */
...
{	
	...
	public class RFID extends EventDispatcher 
	{
		...
		{			
			...
			clip.alpha = 1;
			clip.theText.htmlText = "TOUCH YOUR WRISTBAND BELOW TO START";
			userName = "";
			clip.rfidField.text = "";
