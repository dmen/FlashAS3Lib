...
package com.gmrmarketing.nissan
{
	...
	public class MarkerButtons_web extends EventDispatcher
	{
		public static const M_CLICK:String = "markerButtonClicked";
		
		private var theButtons:Array;
		private var buttonObjects:Array;
		private var xStart:int = 13;
		private var yStart:int = 188;
		private var yBuffer:int = 4;
		...
		public function MarkerButtons_web()
		{
		...
		public function enableButtons():void
		{
			...
			for (var i:int = 0; i < l; i++) {
				...
				buttonObjects[i].buttonMode = true;
				buttonObjects[i].mouseChildren = false;
		...
		public function enableHomeButton():void
		{
			...
			buttonObjects[0].buttonMode = true;
			buttonObjects[0].mouseChildren = false;
		}
		...
		public function disableHomeButton():void
		{
			...
			buttonObjects[0].buttonMode = false;
		}
		...
		public function disableButtons():void
		{
			...
			for (var i:int = 0; i < l; i++) {
				...
				buttonObjects[i].buttonMode = false;				
