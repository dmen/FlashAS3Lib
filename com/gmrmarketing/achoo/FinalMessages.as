...
{ 	
	...
	{		
		...
		{		
			...
			//fail safe to turn off the pump 500 ms adter instantiating
		...
		public function turnOff(e:TimerEvent):void
		{
			...
			helper.log("Sneeze Relay Off - Final Messages Fail Safe");
		}
