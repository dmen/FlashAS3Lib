...
{	
	...
	public class GameIntro
	{
		...
		/**
		 * leaders will contain 0 to 20 leaderboard entries
		 ...
		 * @param	$leaders Array with at max 20 entries
		 */
		public function show(leaders:Array):void
		{
			//populate leaderboard with names/scores
			for (var i:int = 0; i < leaders.length; i++) {
				clip2["n" + i].text = String(i+1) + ". " + leaders[i][0] + " " + String(leaders[i][1]).substr(0, 1) + ".";
				clip2["s" + i].text = String(leaders[i][9]);				
			}
			showLeaderboard();
		}
