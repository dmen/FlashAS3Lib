...
package com.gmrmarketing.esurance.sxsw_2015.photobooth
{
	...
	public class Queue extends EventDispatcher  
	{
		...
		private const DATA_FILE_NAME:String = "esuranceSXSW2015PBQueued.csv"; //current users / not yet uploaded
		private const SAVED_FILE_NAME:String = "esuranceSXSW2015PBSaved.csv"; //users successfully uploaded
