...
package com.gmrmarketing.esurance.sxsw_2015.photobooth
{
	...
	{		
		...
		{		
			...
			var js:String = JSON.stringify({"userName":"sxsw", "password":"sxsw"});
		...
		{	
			if (hasToken()) {
				...
				var resp:Object = { "AccessToken":token, "MethodData": { "InteractionId":176, "DeviceId":"Flash", "DeviceResponseId":13, "ResponseDate":now, "FieldResponses":[ { "FieldId":1168, "Response":formData[0] }], "Latitude":"0", "Longitude":"0" }};
		...
		{
			var resp:Object = { "AccessToken":token, "MethodData": { "InteractionResponseId":responseId, "FieldId":1167, "Response":thePhoto }};			
			var js:String = JSON.stringify(resp);
