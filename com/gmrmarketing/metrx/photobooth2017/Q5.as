package com.gmrmarketing.metrx.photobooth2017
{
	...
	{
		public static const COMPLETE:String = "q4Complete";
		public static const HIDDEN:String = "q4Hidden";
		...
		public function show():void
		{
			...
			TweenMax.to(clip.pic, .5, {x:490, ease:Expo.easeOut, delay:.1});
			...
			TweenMax.to(clip.a4, .5, {x:932, delay:.5});
			TweenMax.to(clip.a5, .5, {x:932, delay:.5});
			TweenMax.to(clip.a6, .5, {x:932, delay:.6, onComplete:startPicAnim});
		}
