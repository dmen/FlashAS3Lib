...
package com.google.maps.examples {
	...
	import com.google.maps.examples.GridBounds;
	...
	public class MarkerManager {
		 ...
		 * Called by constructor and by clearMarkers
		 */ 
		 ...
		 */
		private function removeMarker(marker:Marker):void {
		  var zoom:Number = this.maxZoom_;
		  var changed:Boolean = false;
		 ...
		 * @return {Number}
		 */
		private function getMarkerCount(zoom:Number):Number {
		  var total:Number = 0;
