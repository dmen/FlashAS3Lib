...
package com.rimv.aMediaGallery 
{
	...
	public class mainFlashVar extends MovieClip
	{
		...
		private function xmlLoaded(e:XMLLoaderEvent):void
		{
			...
			ssClip.y = stage.stageHeight * .5 - ssClipDistance;
		...
		// read xml file from flashvar
		private function readFlashvar():void
		{
			try {
				var paramObj:Object = LoaderInfo(this.root.loaderInfo).parameters;
				//mainXMLPath = String(paramObj["XML"]) + "?" + String(Math.random() * 10000000);
				mainXMLPath = String(paramObj["xmlPath"]);
