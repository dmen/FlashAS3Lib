 ...
 * "proportionalOutside",</code> and more. A VideoLoader will dispatch useful events
 * like <code>VIDEO_COMPLETE, VIDEO_PAUSE, VIDEO_PLAY, VIDEO_BUFFER_FULL, VIDEO_BUFFER_EMPTY, NET_STATUS, VIDEO_CUE_POINT</code>, 
 * and <code>PLAY_PROGRESS</code> in addition to the typical loader events, making it easy to hook up your own control 
 * interface. It packs a surprising amount of functionality into a very small amount of kb.<br /><br />
 * 
