package sk.yoz.net
{
    ...
    {		
        ...
        private var tokenCallbackDefined:Boolean;
        private var _authorized:Boolean;
        private var _token:String;
        private var _savedSession:SharedObject;
        ...
        private function get savedSession():SharedObject
        {
            if(_savedSession){
        ...
        {
            return savedSession.data.token ? verifyToken(savedSession.data.token) : null;
        }
        ...
        private function verifyTokenSuccess(event:FacebookOAuthGraphEvent, token:String):void
        {
            _me = event.data;
            _token = token;
            _authorized = true;
        ...
        private function loaderAddListeners(loader:URLLoader):void
        {
        ...
        private function loaderRemoveListeners(loader:URLLoader):void
        {
            var type:String = Event.COMPLETE;
        ...
        private function hashToToken(hash:String):String
        {
        ...
        private function tokenToExpiration(token:String):Date
        {
